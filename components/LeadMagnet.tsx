              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-12 pr-4 py-4 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none text-base transition-all"
                  />
                </div>
                <Button
                  type="submit"
